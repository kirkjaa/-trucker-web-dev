...
echo ""
echo -e "${BLUE}🔐 Login Credentials (Desktop & Mobile share same accounts):${NC}"
echo -e "   All passwords: ${GREEN}Demo@123${NC}"
echo -e "   Super Admin:   ${GREEN}superadmin@demo.com${NC}"
echo -e "   Factory:       ${GREEN}factory@demo.com${NC}"
echo -e "   Company:       ${GREEN}company@demo.com${NC}"
echo -e "   Driver:        ${GREEN}driver@demo.com${NC} (main mobile use case)"
echo -e "   More accounts: See ${GREEN}LOGIN_CREDENTIALS.md${NC}"

echo ""
echo -e "${BLUE}📊 Data Sharing:${NC}"
echo -e "   Both desktop and mobile apps share the SAME PostgreSQL database."
echo -e "   Changes made on one platform will reflect on the other."
