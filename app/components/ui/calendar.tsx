  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: "text-calendar-day-text w-10 font-normal text-base",
        ...
        selected: "bg-calendar-selected text-secondary-teal-green-04",
        today: "bg-calendar-today text-neutral-400",
        outside:
