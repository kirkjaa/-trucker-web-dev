...
// export default function BidCanceledTable() {
//   // Global State
...
//                 <p className="body2 text-urgent-fail-02 bg-toast-error-background px-4 py-1 w-fit rounded-3xl">
//                   {data.bidStatus === EBidStatus.CANCELED ? "• ยกเลิก" : "-"}
//                 </p>
//               </TableCell>
