  ...
  return (
    <div className="flex gap-16 pl-10 text-main-02 border-b">
      <div
        ...
        onClick={() => router.push(EComPathName.QUOMAR)}
      >
        <Icons
          name={
            pathName === EComPathName.QUOMAR
      ...
      <div
        ...
        onClick={() => router.push(EComPathName.QUOMAR_OFFERED)}
      >
        <Icons
          name={
            pathName === EComPathName.QUOMAR_OFFERED
      ...
      <div
        ...
        onClick={() => router.push(EComPathName.QUOMAR_REJECTED)}
      >
        <Icons
          name={
            pathName === EComPathName.QUOMAR_REJECTED
      ...
      <div
        ...
        onClick={() => router.push(EComPathName.QUOMAR_CANCELED)}
      >
        <Icons
          name={
            pathName === EComPathName.QUOMAR_CANCELED
