...
// import { EBidStatus, ERfqType } from "@/app/types/enum";
...
// export default function BidRejectedTable() {
//   // Global State
...
//                 <p className="body2 text-neutral-07 bg-neutral-03 px-4 py-1 w-fit rounded-3xl">
//                   {data.bidStatus === EBidStatus.REJECTED ? "• ปฏิเสธ" : "-"}
//                 </p>
//               </TableCell>
